                ...
                <div className="container">
                    <div className="category__wrapper">
                        <div className="category__top-box">
                            <h2 className="category__top-box__title">Popular tech companies who are seeking talents in our website</h2>
                            ...
                            <div className="category__bottom-box__cards">
                                {
                                    categoryData?.map((category) => (
                                        <div key={category.id} className="category__bottom-box__card">
                                            ...
                                            <h3 className="category__bottom-box__title">{category.title}</h3>
